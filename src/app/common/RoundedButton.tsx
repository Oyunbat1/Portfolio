    ...
    return (
        <Magnetic>
            <div className='bg-[#1C1D20] rounded-full text-white'>
                <div
                    className="rounded-full border border-[#888] cursor-pointer relative flex items-center justify-center w-[80px] h-[80px] lg:w-[130px] xl:w-[160px] xl:h-[160px] lg:h-[130px] p-[10px] overflow-hidden group hover:bg-blue-600 transition duration-300"
